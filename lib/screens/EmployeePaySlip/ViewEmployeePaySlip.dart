                        ...
                        if (invoice.empsalReg!.hra != '0' &&
                          ...
                          pw.TableRow(children: [
                            pw.Padding(
                              padding: const pw.EdgeInsets.all(5),
                              child:
                                  pw.Text('HRA', textAlign: pw.TextAlign.left),
                            ),
                            pw.Padding(
                              padding: const pw.EdgeInsets.all(5),
                        ...
                        if (invoice.empsalReg!.lta != '0' &&
                          ...
                          pw.TableRow(children: [
                            pw.Padding(
                              padding: const pw.EdgeInsets.all(5),
                              child:
                                  pw.Text('LTA', textAlign: pw.TextAlign.left),
                            ),
                            pw.Padding(
                              padding: const pw.EdgeInsets.all(5),
                        ...
                        child:
                          ...
                          pw.TableRow(children: [
                            pw.Padding(
                              padding: const pw.EdgeInsets.all(5),
                              child:
                                  pw.Text('PT', textAlign: pw.TextAlign.left),
                            ),
                            pw.Padding(
                              padding: const pw.EdgeInsets.all(5),
